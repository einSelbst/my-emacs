;;; init-siren-desktop.el --- jimeh's Emacs Siren: desktop configuration.

;;; Commentary:

;; Basic configuration for desktop. Try this instead of my default desktop.el persistency.
;; https://github.com/jimeh/.emacs.d/blob/v0.7.8/modules/workspaces/siren-desktop.el
...
(provide 'init-siren-desktop)
;;; init-siren-desktop.el ends here
